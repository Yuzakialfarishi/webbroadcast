    ...
    <div class="content-card">
        <form method="POST" action="{{ route('admin.pengurus.update', $penguru) }}" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 25px;">
                <label for="nama" style="display: block; font-weight: 600; color: #333; margin-bottom: 8px;">
            ...
            <div style="margin-bottom: 25px;">
                <label for="jabatan" style="display: block; font-weight: 600; color: #333; margin-bottom: 8px;">
            ...
            <div style="margin-bottom: 25px;">
                <label for="kontak" style="display: block; font-weight: 600; color: #333; margin-bottom: 8px;">
                    <i class="fas fa-phone"></i> Kontak (Opsional)
                </label>
